                        ...
                        <div class="pt-3 sm:pt-5 lg:pt-0">
                            ...
                            <div class="w-full float-left">
                                <div class="grid lg:flex-col grid-cols-4 gap-4">
                                    <div class="align-middle text-xl font-semibold text-black dark:text-white" class="align-self-center">
                                        Nome
                                    </div>
                                    <div class="align-middle text-xl font-semibold text-black dark:text-white">
                                        Skills
                                ...
                                <div class="mt-3 lg:flex-col grid grid-cols-4 gap-4">
                                    <div class=" align-self-center">
                                        <h2 class="align-middle text-md font-semibold text-black dark:text-white">Pedro Antonio Dos Santos (Pepper)</h2>
                                    </div>
                                    <div>
                                        <img  class="lg:flex-col h-1/2"
                                        src="https://skillicons.dev/icons?i=bash,docker,git,github" />
                                    </div>
