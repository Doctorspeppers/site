<div class="mt-3 lg:flex-col grid grid-cols-4 gap-4">
    ...
    <div class="grid grid-cols-3">
        <a href="{{ route('projects.show', ['project' => $id]) }}" class="text-white text-center bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
            view
        </a>
